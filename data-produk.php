...
<body >
    ...
    <div class = "section">
        <div class= "container">
             <h3>Data Produk</h3>
             <div class="box">
                 <p><a href="tambah-produk.php" class="tambah_data" ><img src="img/kategori.png">  Tambah data</a></P><br>
               <table border="1" cellspacing="0" class="table">
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               <a href="edit-produk.php?id=<?php echo $row['produk_id'] ?> " class="btn-merah">Edit</a> 
                                <a href = "proses-hapus.php?idp=<?php echo $row['produk_id'] ?>" class="btn-kuning" onclick="return confirm('yakin ingin hapus?')">Hapus</a> 
                           </td>
                       </tr>
                       <?php }}else{ ?>
                            <tr>
